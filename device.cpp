...
void Device::recreateSwapChain(GLFWwindow* window,VkSurfaceKHR surface) {
...
void Device::createTextureImage(){
    ...
    stbi_uc* pixels = stbi_load("textures/ground.png", 
    ...
    textureImage, textureImageMemory, logicDevice, physicalDevice);
