...
void device::pickPhysDevice(VkInstance instance){
...
void device::createLogicalDevice(bool enableValidationLayers){
    ...
    vkGetDeviceQueue(logicDevice, indices.graphicsFamily.value(), 0, &gQueue);
    vkGetDeviceQueue(logicDevice, indices.presentFamily.value(), 0, &presentQueue);
}

void device::setSurface(VkSurfaceKHR i_surface){
    surface = i_surface;
}


//--------------------------------
//here begins functions about swapchain, maybe add to another file=
//--------------------------------
...
VkExtent2D device::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
    if (capabilities.currentExtent.width != UINT32_MAX) {
        ...
        //this should be equal to the constant valie
        //TODO: this
